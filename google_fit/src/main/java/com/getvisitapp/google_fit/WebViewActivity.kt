...
//        val magicLink =
//            "https://star-health.getvisitapp.com/?code=VnFDTdSt&pid=1634229"
        val magicLink =
            "https://star-health.getvisitapp.net/?code=rMV0IVkd&pid=2219"
    ...
    override fun syncDataWithServer(
        ...
        Timber.d("mytag: syncDataWithServer() called with: baseUrl: $baseUrl, authToken: $authToken, googleFitLastSync: $googleFitLastSync, gfHourlyLastSync: $gfHourlyLastSync")
