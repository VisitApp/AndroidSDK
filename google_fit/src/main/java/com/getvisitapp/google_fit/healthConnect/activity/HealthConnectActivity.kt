...
//        PERMISSION_READ_HEALTH_DATA_HISTORY
    ...
    private val coroutineExceptionHandler =
        CoroutineExceptionHandler { coroutineContext, throwable ->
             Timber.tag("mytag").d("HealthConnectActivity coroutineExceptionHandler")
            throwable.printStackTrace()


            val formattedMessage = "${throwable.javaClass}: ${throwable.message}"
             Timber.tag("mytag").d("$formattedMessage")
    ...
    val requestPermissions =
        registerForActivityResult(requestPermissionActivityContract) { granted: Set<String> ->
             ...
             Timber.tag("mytag").d("granted permission: $granted")

            if (granted.containsAll(PERMISSIONS)) {
                 Timber.tag("mytag").d("Permissions successfully granted")
                ...
                scope.launch {
                 ...
                 Timber.tag("mytag").d(" Lack of required permissions")
        ...
        when (availabilityStatus) {
            ...
            HealthConnectClient.SDK_AVAILABLE -> {
                ...
                scope.launch {
                 ...
                 Timber.tag("mytag").d("availabilityStatus else")
            }
        }
    }
    ...
    fun checkHealthConnectAvailabilityStatus(): Int {
        ...
        val availabilityStatus = HealthConnectClient.getSdkStatus(this)
         Timber.tag("mytag").d("availabilityStatus: $availabilityStatus")
    ...
    private suspend fun checkPermissionsAndRun() {
        ...
        if (granted.containsAll(PERMISSIONS)) {
            ...
            // Permissions already granted; proceed with inserting or reading data
             ...
             Timber.tag("mytag").d("All Permission Allowed")

            var timeStamp = 1754035923000L //current time
...
//                getActivityData(type = "sleep", frequency = "week", timeStamp = timeStamp)
             ...
             Timber.tag("mytag").d("Permission Not present")
...
//           Today's steps and sleep data.
    ...
    suspend fun getDailySyncData(timeStamp: Long): DailyStepSyncRequest {
        ...
        val requestBody = DailyStepSyncRequest(fitnessData = dailySyncData, platform = "ANDROID")
         ...
         Timber.tag("mytag").d("getDailySyncData: requestBody: ${Gson().toJson(requestBody)}")
    ...
    suspend fun exhaustHealthConnectQueryLimitTest(timeStamp: Long) {
        (1..1000).forEachIndexed { index, i ->
             Timber.tag("mytag").d("exhaustHealthConnectQueryLimitTest: index: $index")
            getHourlySyncData(timeStamp)
        }
    }
    ...
    suspend fun getHourlySyncData(timeStamp: Long): HourlyDataSyncRequest {
        ...
        val requestBody =
         ...
         Timber.tag("mytag").d("getHourlySyncData: requestBody: ${Gson().toJson(requestBody)}")
